...
function(config) {
var $ = apex.jQuery,
toolbarData = $.apex.interactiveReport.copyDefaultToolbar(),
toolbarGroup = toolbarData.toolbarFind("a-IRR-actions"); // this is the group with the actions menu
